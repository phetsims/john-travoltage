...
(5) Open in the browser: `http://localhost/john-travoltage/john-travoltage_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/john-travoltage/build/adapted-from-phet/john-travoltage_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
