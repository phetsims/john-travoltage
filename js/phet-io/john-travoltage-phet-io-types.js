...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(ElectronIO)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> ElectronIO<br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
      ...
      "supertype": "ParametricTypeImplIO.<ElectronIO, VoidIO>",
      "typeName": "FunctionIO.(ElectronIO)=>VoidIO"
    },
    ...
    "JohnTravoltageModelIO": {
      "documentation": "The model for John Travoltage",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "JohnTravoltageModelIO"
    },
    "NodeIO": {
    ...
    "ObservableArrayIO.<ElectronIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<ElectronIO>",
    ...
    "ParametricTypeImplIO.<ElectronIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ElectronIO, VoidIO>"
    },
    "ParametricTypeImplIO.<ElectronIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ElectronIO>"
    },
