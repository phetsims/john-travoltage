...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(ElectronIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<ElectronIO, VoidIO>",
    ...
    "ObservableArrayIO.<ElectronIO>": {
      ...
      "supertype": "ParametricTypeIO.<ElectronIO>",
    ...
    "ParametricTypeIO.<ElectronIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ElectronIO, VoidIO>"
    },
    "ParametricTypeIO.<ElectronIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ElectronIO>"
    },
