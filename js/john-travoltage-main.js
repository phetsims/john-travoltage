...
const simOptions = {
  credits: {
    ...
    qualityAssurance: 'Logan Bray, Steele Dalton, Bryce Griebenow, Clifford Hardin, Liam Mulhall, <br>Devon Quispe, Ben Roberts, Oliver Orejola, Nancy Salpepi, Kathryn Woessner',
