...
// i18n strings
const arrowKeysMoveFootString = johnTravoltageStrings.arrowKeysMoveFoot;
const escapeKeyDescriptionString = johnTravoltageStrings.escapeKeyDescription;
const escKeyString = johnTravoltageStrings.escKey;
const hotKeysAndHelpString = johnTravoltageStrings.hotKeysAndHelp;
const orString = johnTravoltageStrings.or;
const shiftKeyString = johnTravoltageStrings.shiftKey;
const shiftTabKeyDescriptionString = johnTravoltageStrings.shiftTabKeyDescription;
const tabKeyDescriptionString = johnTravoltageStrings.tabKeyDescription;
const tabKeyString = johnTravoltageStrings.tabKey;

const JohnTravoltageA11yStrings = {
...
if ( phet.chipper.queryParameters.stringTest === 'xss' ) {
  for ( const key in JohnTravoltageA11yStrings ) {
...
export default JohnTravoltageA11yStrings;